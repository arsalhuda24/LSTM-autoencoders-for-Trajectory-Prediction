...
# """Ground truth"""
# dat_gt= cv2.imread("C:/Users/arsal/Desktop/ITSC/annotations_for_segnet/hotel/label/Label_33.png")
# dat_gt=cv2.resize(dat_gt,(480,640))
# dat_gt= torch.tensor(dat_gt)

# """semantic embedding"""
# eth_embed= np.load("C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/semantic_embedding/embeddings/hotel.npy")
# eth_embed= torch.Tensor(eth_embed)
#
# hotel_embed = np.load("C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/semantic_embedding/embeddings/hotel.npy")
# hotel_embed = torch.Tensor(hotel_embed)
...
def get_trajs(frame, step=10):
    ...
    if considered_ped > 0:
        ...
        for model_name, model in models.items():
            print("asssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssaaaaaaaaaaaaaaaaaaaaa")
            if model_name=='rnn':
            ...
            # if model_name == 'gt_seg':
            #     pred_rel = model(obs_list_tensor, obs_list_rel_tensor, seq_start_end_tensor, dat_gt)
            #     pred_abs = relative_to_abs(pred_rel, obs_list_tensor[-1]).detach().cpu().numpy()
            #     pred_abs_reorder = np.swapaxes(pred_abs, 0, 1)
            #     key = "pred_" + model_name
            #     for k in range(considered_ped):
            ...
            #         trajs_[ped_id][key] = pred_abs_reorder[k]
                        ...
                        # print(trajs_)
            """Semantic Embedding PSP-Net"""
            # if model_name == 'semantic':
            #     pred_rel = model(obs_list_tensor, obs_list_rel_tensor, seq_start_end_tensor, hotel_embed)
            #     pred_abs = relative_to_abs(pred_rel, obs_list_tensor[-1]).detach().cpu().numpy()
            #     pred_abs_reorder = np.swapaxes(pred_abs, 0, 1)
            #     key = "pred_" + model_name
            #     for k in range(considered_ped):
...
def get_paths(dset_):
    ...
    if dset_.split("/")[0] == "split_moving":
        ...
        # model_path_us="C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/trained_models/Tokka/RNN-AE-Scene/ETH/200_epochs/checkpoint_with_model.pt"
        #model_path_vgg="C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/vgg_analysis/pretrained-models/hotel/checkpoint_with_model.pt"
        ...
        # model_path_sgan = "models/sgan-p-models/" + dset + "_12_model.pt"
        # model_path_sgan= "C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/models/sgan-p-models/hotel_12_model.pt"
        ...
        model_path_segnet_full="C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/trained_models/Tokka/SegNet-full-AE-Scene/eth/checkpoint_with_model.pt"
                          #"C:\Users\arsal\PycharmProjects\SGAN-AE-master\SGAN-AE-master\trained_models\Tokka\SegNet-full-AE-Scene\hotel\checkpoint_with_model.pt"
       # model_path_gt="C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/trained_models/Tokka/Ground-Truth/hotel/checkpoint_with_model.pt"
        ...
        # C:\Users\arsal\PycharmProjects\SGAN - AE - master\SGAN - AE - master\datasets
        # test_dataset_path = os.listdir("C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/datasets/" + dset + "/test")
        dset='eth'
...
# "C:\Users\arsal\PycharmProjects\SGAN-AE-master\SGAN-AE-master\trained_models\Tokka\RNN-AE-Scene\ETH\200_epochs\checkpoint_with_model.pt"
    ...
    # checkpoint_gt_seg=torch.load(paths["model_gt"], map_location='cpu')
   # models['gt_seg'] = get_generator_gt(checkpoint_gt_seg)
